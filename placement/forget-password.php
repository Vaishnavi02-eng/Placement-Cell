...
{
$ret=mysqli_query($conn,"SELECT * FROM student WHERE email='".$_POST['username']."'");
...
///////////////////////////////////////////////////
                echo "<script>alert('Please Check Login');</script>";
				$mail = new PHPMailer; 
				...
				$sql=mysqli_query($conn,"Update student set password='$password' where email='".$_POST['username']."'");
